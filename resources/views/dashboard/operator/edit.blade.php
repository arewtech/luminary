@extends('layouts.app', ['title' => 'Edit Operator - ' . $operator->username])
@section('content')
            ...
            <div class="card-body">
                ...
                <form action="{{ route('operator.update', $operator) }}" method="post" class="row g-3"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="occupation" value="{{ old('occupation', $operator->occupation) }}"
                        ...
                        <div class="d-flex align-items-center justify-content-start gap-3">
                            <div class="form-check">
                                <input class="form-check-input" name="status" type="radio" id="active"
                                    value="active" {{ $operator->status == 'active' ? 'checked' : '' }}>
